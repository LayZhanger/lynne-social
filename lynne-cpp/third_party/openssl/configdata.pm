...
unless (caller) {
    ...
    use lib '/root/Lynne/lynne-cpp/third_party/openssl/util/perl';
    use OpenSSL::fallback '/root/Lynne/lynne-cpp/third_party/openssl/external/perl/MODULES.txt';
    ...
    if (scalar @ARGV == 0) {
        ...
        use lib '.';
        use lib '/root/Lynne/lynne-cpp/third_party/openssl/Configurations';
        use gentemplate;
